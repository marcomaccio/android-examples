...
import name.marmac.tutorials.android.bankaccountanalyzer.services.datasync.AccountContract;

import static name.marmac.tutorials.android.bankaccountanalyzer.services.datasync.AccountContract.sServerAuthenticate;
...
public class AuthenticatorActivity extends AccountAuthenticatorActivity {
    ...
    /**
     * Call when the SignUpActivity send back the result of its account creation
     *
     * @param requestCode
     * @param resultCode
     * @param data
    ...
    public void submit() {
        ...
        new AsyncTask<String, Void, Intent>() {
            ...
            protected Intent doInBackground(String... params) {
                ...
                Log.d("marmac", TAG + "> Started authenticating");
